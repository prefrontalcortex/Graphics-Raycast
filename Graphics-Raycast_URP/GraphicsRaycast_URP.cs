...
public static class GraphicsRaycast_URP
{
    ...
    private static Camera CreateRayCam()
    {
        ...
        Camera rayCam; 
        RayCamObj = GameObject.Find("RaycastCam");
    ...
    public static bool Raycast(Vector3 origin, Vector3 direction, out RaycastHit hit, float maxDistance, int layerMask = -1)
    {
        ...
        bool hasHit = false;
        maxDistance = Mathf.Clamp(maxDistance, 0f, 100f);
        ...
        Debug.Log($"Output Color is {outputColor}");
        ...
        //Scaling is happening in the shader
